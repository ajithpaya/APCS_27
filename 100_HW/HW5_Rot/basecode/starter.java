...
public class starter {
    ...
    //TODO 1: Roll your fighter's stats using Math.random(). Create:
        ...
        int rivalDefese = (int)(Math.random() * 20) + 15;

        System.out.println();
        System.out.println("BOMBARDIRO CROCODILO  |  HP " + rivalHealth + "  POWER " + rivalPower + "  DEFENSE " + rivalDefese);
        System.out.println();
        ...
        int finalDamage = Math.max(rawDamage - rivalDefese,10);
